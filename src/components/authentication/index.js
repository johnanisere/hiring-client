...
const VerifyHirer = lazy(() =>
	import('../HirerSignUp/VerifyHirer')
);
const HirerLogin = lazy(() =>
	import('../HirerSignUp/hirerLogin/HirerLogin')
);
...
const InterviewResponse = lazy(() =>
	import(
		'../interviewActivities/InterviewResponse'
	)
);
const ScheduleTest = lazy(() =>
	import('../schedule-test/ScheduleTest')
);
